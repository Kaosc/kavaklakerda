...
export default function ActiveTimes({ timer, isOpen }: { timer: { hours: number; min: number; sec: number }; isOpen: boolean }) {
	return (
		<div className={`flex flex-col justify-center items-center transition-all ease-in-out animate-in fade-in-0 duration-1000`}>
			...
			<div className={`flex flex-row justify-center items-center text-xl max-mobile:text-xs mt-3 transition-all ease-in-out`}>
